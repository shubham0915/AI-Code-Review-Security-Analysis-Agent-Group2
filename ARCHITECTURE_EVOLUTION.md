...
To ensure the AI Agent reviews code against official security standards without hallucinating, we use Retrieval-Augmented Generation (RAG) powered by local `Ollama` embeddings and `ChromaDB`.
